...
{
    /// <summary>
    /// Validates the <see cref="ItemSorter"/>
    /// </summary>
    public class ItemSorterValidator : EntityValidatorImpl<ItemSorter>
    {
        ///<inheritdoc />
        protected override List<ValidationResult> ValidateInternal(ItemSorter src)
        {
