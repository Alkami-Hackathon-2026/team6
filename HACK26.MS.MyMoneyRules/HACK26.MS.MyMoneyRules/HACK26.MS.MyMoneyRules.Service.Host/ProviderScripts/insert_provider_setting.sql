...
/****************************************************
	START EDIT
****************************************************/
declare @providerTypeName nvarchar(30) = 'HACK26'
declare @providerTypeDisplayName nvarchar(max) = 'HACK26'
declare @providerTypeDescription nvarchar(max) = 'HACK26'

declare @providerName nvarchar(50) = 'HACK26.MS.MyMoneyRules'
declare @providerDescription nvarchar(100) = 'HACK26 MyMoneyRules'
...
select * from core.item where [Name] = 'HACK26.MS.MyMoneyRules';
